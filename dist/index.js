(() => {
  ...
  var videoComponentAnimation = (name) => {
    ...
    $(".home-video_component").each(function(index, element) {
      ...
      let tlGrow = gsapWithCSS.timeline({
        scrollTrigger: {
  ...
  var marketSwiper = () => {
    var menu = ["Sports & Hospitality", "Mobile Work & Learning", "Film & Production Support", "Events &\xA0Roadshow", "Sales &\xA0Promotion", "Living &\xA0LIfestyle"];
