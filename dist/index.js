(() => {
  ...
  // src/utils/about-page/aboutSwiper.js
  var aboutSwiper = () => {
  ...
  // src/utils/client-cases-page/clientCasesSwiper.js
  var clientCasesSwiper = () => {
  ...
  // src/utils/global/lenisScroll.js
  var lenisScroll = () => {
    "use strict";
    if (window.Webflow.env("editor") === void 0) {
      let raf = function(time) {
        lenis.raf(time);
        requestAnimationFrame(raf);
      }, connectToScrollTrigger = function() {
  ...
  // src/utils/global/marketSwiper.js
  var marketSwiper = () => {
    var menu = [
      "Sports & Hospitality",
    ...
    var mySwiper = new Swiper("#markets", {
      ...
      on: {
        slideChange: function() {
          ...
          gsapWithCSS.to(paginationWrapper, {
            duration: 0.3,
            x: -newLeftPosition,
            ease: "power2.inOut"
          });
  ...
  // src/utils/global/customMenuTheme.js
  var customMenuTheme = () => {
  };

  // src/utils/global/smallCustomCode.js
  var smallCustomCode = () => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
      document.querySelectorAll(".products-products_item").forEach((trigger) => {
        trigger.addEventListener("mouseover", function() {
          this.querySelectorAll(".text-link-hover").forEach(
            (target) => target.classList.add("is-hover")
          );
        });
      });
      document.querySelectorAll(".products-products_item").forEach((trigger) => {
        trigger.addEventListener("mouseout", function() {
          this.querySelectorAll(".text-link-hover").forEach(
            (target) => target.classList.remove("is-hover")
          );
        });
      });
    });
  ...
  function imageSequence(config3) {
    ...
    let playhead = { frame: 0 }, ctx = gsapWithCSS.utils.toArray(config3.canvas)[0].getContext("2d"), onUpdate = config3.onUpdate, images, updateImage = function() {
      ...
      const parentContainer = document.querySelector(config3.parentContainer);
  ...
  // src/utils/product-page/productSwipers.js
  var productSwipers = () => {
    var mySwiper = new Swiper("#alternating", {
      // If we need pagination
      modules: [Navigation, Pagination, Keyboard],
  ...
  // src/utils/markets-page/hoverAnimationCard.js
  var hoverAnimationCard = () => {
    const animateOnHover = ($headingBox) => {
      ...
      gsapWithCSS.to([$image, $imageItem], {
        duration: 0.5,
        scale: 0.994,
        ease: "power2.out"
      });
      gsapWithCSS.to($imageItem, {
        duration: 0.5,
        scale: 1.03,
        ease: "power2.out"
      });
  ...
  // src/utils/global/UspAnimation.js
  var uspAnimation = () => {
    gsapWithCSS.registerPlugin(ScrollTrigger3);
    ScrollTrigger3.defaults({
      markers: false
  ...
  // src/utils/global/productAnimation.js
  var productAnimation = (name) => {
    gsapWithCSS.registerPlugin(ScrollTrigger3);
    ScrollTrigger3.defaults({
      markers: false
    });
